import React, { cloneElement, FC, HTMLAttributes, ReactElement, ReactNode, useEffect, useState } from 'react';
...
const Popovers: FC<IPopoversProps> = ({
	...
	useEffect(() => {
		...
		// Cleanup function to remove listener when component unmounts or popover closes
		return () => {
			document.removeEventListener('mousedown', handleClickOutside);
		};
	// eslint-disable-next-line react-hooks/exhaustive-deps
	}, [popoverOpen, popperElement, referenceElement]);
