...
const statusChoices = ["Active", "Disabled", "Deleted"]
const FilterChoices=[ {label:'Created Date',value:'created_date__date'},
    {label:'Last Modified Date',value:'modified_date__date'},
    {label:'Next Cleaning Date',value:'next_cleaning_date'},
    {label:'Last Cleaning Date',value:'last_cleaning_date'},]


const GreaseTrapFilters = ({onFilterHandler}) => {
...
export default GreaseTrapFilters;