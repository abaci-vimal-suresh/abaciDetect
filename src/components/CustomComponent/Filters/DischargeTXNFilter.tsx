...
const statusChoices = ["Accepted", "Rejected", "Pending"]
const FilterChoices = [
  { label: "Exit TIme", value: "exit_time" },
  { label: "Entry TIme", value: "entry_time" },
];


const DischargeTxnFilter = ({onFilterHandler}) => {
    ...
    return (
        <Dropdown isOpen={filterMenu} setIsOpen={setFilterMenu}>
            <DropdownToggle hasIcon={false}>
                <Button icon='FilterAlt' color='secondary' isLight aria-label='Filter' />
            </DropdownToggle>
...
export default DischargeTxnFilter;