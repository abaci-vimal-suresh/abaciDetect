...
const FilterChoices = [
  { label: "Initiated Date", value: "initiated_date" },
  { label: "Collected Date", value: "collected_date" },
  { label: "Discharged Date", value: "discharged_date" },
  { label: "Skipped Date", value: "skipped_date" },
  { label: "Canceled Date", value: "canceled_date" }
];


const ServiceRequestFilter = ({onFilterHandler}) => {

    const [selectedStatusList, setSelectedStatusList] = useState<string[]>(['Active']);
    const [selectedFilterList, setSelectedFilterList] = useState<object>({ label: "Initiated Date", value: "initiated_date" });
