...
const FilterChoices=[ {label:'Created Date',value:'created_date__date'},
    {label:'Last Modified Date',value:'entity_details_last_modified_date__date'},
    {label:'Last Inspected Date',value:'last_inspected_date__date'},]


const EstablishmentFilter = ({onFilterHandler}) => {
