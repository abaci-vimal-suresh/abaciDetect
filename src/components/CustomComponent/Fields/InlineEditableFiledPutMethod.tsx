...
const InlineEditableFieldPutMethod: React.FC<InlineEditableFieldProps> = ({
    initialValue,
    patchUrl,
    fieldKey,
    className = '',
    ...
    const handleBlurOrEnter = async () => {
        ...
        try {
            setLoading(true);
            // console.log(patchUrl, id, fieldKey, value);
            // console.log(`${patchUrl}/${id}/`);
            await authAxios.put(`${patchUrl}${id}/`, { [fieldKey]: value });
...
export default InlineEditableFieldPutMethod;
