...
interface UserTypeListComponentProps {
    tableRef: MutableRefObject<any>;
    activeTab: string;
    urlBackup: MutableRefObject<string>;
}

const UserTypeListComponent: React.FC<UserTypeListComponentProps> = ({
    tableRef,
    activeTab,
    urlBackup,
}) => {
    ...
    const staticColumns: Column<UserTypeListTableData>[] = [
        {
            title: 'Name',
            field: 'name',
                        ...
                        new Promise((resolve, reject) => {
                            ...
                            const statusFilter =
                                activeTab && activeTab !== 'All'
                                    ? `&status=${activeTab}`
                                    : '';
                            const url = `/user_management/user_types?limit=${query.pageSize}&offset=${
