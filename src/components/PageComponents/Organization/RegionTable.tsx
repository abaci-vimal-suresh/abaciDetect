  ...
  const columns = [
    {
      title: "Group ID",
      field: "group_id",
      render: rowData => rowData?.group_id || NoData,
    },
    {
      title: "Group Name",
      field: "group_name",
      render: rowData => rowData?.group_name || NoData,
    },
    {
      title: "Description",
      field: "description",
      render: rowData => rowData?.description || NoData,
    },
    {
      title: "Regions",
      field: "regions",
      render: rowData => rowData?.regions?.join(", ") || NoData,
    },
  ];
