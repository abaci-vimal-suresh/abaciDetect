...
interface GateListTableTableProps {
    tableRef: MutableRefObject<any>;
    urlBackup: MutableRefObject<string>;
    editModalToggle?: (id: any) => void;
}

const GateListTableTable: React.FC<GateListTableTableProps> = ({
    tableRef,
    urlBackup,
    editModalToggle
}) => {
    ...
    const actionButtons: Column<GateListTableTableData>[] = canManageBuilding
        ? [
            {
                title: 'Actions',
                align: 'right',
