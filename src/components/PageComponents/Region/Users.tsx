...
function Users({tableRef}) {
    ...
    const columns = [
  {
    title: "Name",
    field: "name",
    render: rowData => rowData?.name || NoData,
  },
  {
    title: "Designation",
    field: "designation",
    render: rowData => rowData?.designation || NoData,
  },
  {
    title: "Email ID",
    field: "email_id",
    render: rowData => rowData?.email_id || NoData,
  },
  {
    title: "Mobile No",
    field: "mobile_no",
    render: rowData => rowData?.mobile_no || NoData,
  },
  {
    title: "Party Type",
    field: "party_type",
    render: rowData => rowData?.party_type || NoData,
  },
  {
    title: "Role",
    field: "role",
    render: rowData => rowData?.role || NoData,
  },
  {
    title: "Profile",
    field: "profile",
    render: rowData => rowData?.profile || NoData,
  },
  {
    title: "Region",
    field: "region",
    render: rowData => rowData?.region || NoData,
  },
  {
    title: "Status",
    field: "status",
    render: rowData => rowData?.status || NoData,
  },
];
