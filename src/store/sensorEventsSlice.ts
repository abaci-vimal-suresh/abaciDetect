...
// Selectors
export const selectAllEvents = (state) => state.sensorEvents.events;
export const selectAllAlerts = (state) => state.sensorEvents.alerts;
export const selectUnreadCount = (state) => state.sensorEvents.unreadCount;
export const selectSensorStatus = (sensorId) => (state) =>
    state.sensorEvents.sensorStatuses[sensorId];
export const selectAirQuality = (sensorId) => (state) =>
    state.sensorEvents.airQualityData[sensorId];
export const selectRecentAlerts = (count = 5) => (state) =>
    state.sensorEvents.alerts.slice(0, count);