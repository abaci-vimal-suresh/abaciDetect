...
// Per-floor aggregated data — keyed by floor ID
// Used by DigitalTwinPage when HALO_USE_MOCK=true
export const DUMMY_AGGREGATED_BY_FLOOR: Record<number, typeof DUMMY_AGGREGATED_DATA> = {

    // North Block Ground Floor (id: 10) — sensors 1 (online) + 2 (alert)
    10: {
        aggregated_data: {
            temperature_min: 22.4, temperature_max: 28.1,
            temperature_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            temperature_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            humidity_min: 48.2, humidity_max: 62.5,
            humidity_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            humidity_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            light_min: 380, light_max: 420,
            light_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            light_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            pressure_min: 1013.2, pressure_max: 1014.0,
            pressure_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            pressure_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            sound_min: 42, sound_max: 78,
            sound_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            sound_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            co2_min: 598, co2_max: 1340,
            co2_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            co2_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            tvoc_min: 125, tvoc_max: 342,
            tvoc_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            tvoc_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            pm1_min: 4, pm1_max: 18,
            pm25_min: 7, pm25_max: 28,
            pm10_min: 12, pm10_max: 45,
            pm1_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            pm1_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            pm25_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            pm25_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            pm10_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            pm10_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            aqi_min: 34, aqi_max: 118,
            aqi_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            aqi_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            health_min: 2.8, health_max: 4.2,
            health_min_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            health_max_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            noise_min: 42, noise_max: 78,
            noise_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            noise_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            motion_min: 12, motion_max: 88,
            movement_min: 5, movement_max: 72,
            motion_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            motion_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            movement_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            movement_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            co_min: 0.8, co_max: 1.6,
            no2_min: 18, no2_max: 26,
            nh3_min: 0.1, nh3_max: 0.4,
            co_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            co_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            no2_min_sensor: { sensor_id: 1, sensor__name: 'HALO-GF-01' },
            no2_max_sensor: { sensor_id: 2, sensor__name: 'HALO-GF-02' },
            nh3_min_sensor: null,
            nh3_max_sensor: null,
        },
    ...
    // North Block First Floor (id: 11) — sensors 3 (online) + 4 (alert, server room)
    11: {
        aggregated_data: {
            temperature_min: 23.8, temperature_max: 38.2,
            temperature_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            temperature_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            humidity_min: 28.4, humidity_max: 52.1,
            humidity_min_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            humidity_max_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            light_min: 450, light_max: 640,
            light_min_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            light_max_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            pressure_min: 1012.8, pressure_max: 1014.0,
            pressure_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            pressure_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            sound_min: 38, sound_max: 62,
            sound_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            sound_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            co2_min: 820, co2_max: 1050,
            co2_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            co2_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            tvoc_min: 90, tvoc_max: 210,
            tvoc_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            tvoc_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            pm1_min: 3, pm1_max: 10,
            pm25_min: 5, pm25_max: 14,
            pm10_min: 8, pm10_max: 22,
            pm1_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            pm1_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            pm25_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            pm25_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            pm10_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            pm10_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            aqi_min: 22, aqi_max: 75,
            aqi_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            aqi_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            health_min: 1.8, health_max: 4.1,
            health_min_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            health_max_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            noise_min: 38, noise_max: 62,
            noise_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            noise_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            motion_min: 5, motion_max: 48,
            movement_min: 2, movement_max: 35,
            motion_min_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            motion_max_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            movement_min_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            movement_max_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            co_min: 0.5, co_max: 1.1,
            no2_min: 12, no2_max: 20,
            nh3_min: 0.0, nh3_max: 0.2,
            co_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            co_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            no2_min_sensor: { sensor_id: 3, sensor__name: 'HALO-FF-01' },
            no2_max_sensor: { sensor_id: 4, sensor__name: 'HALO-FF-02' },
            nh3_min_sensor: null,
            nh3_max_sensor: null,
        },
    },

    // South Block Ground Floor (id: 20) — sensors 5 (offline) + 6 (online)
    20: {
        aggregated_data: {
            temperature_min: 19.6, temperature_max: 19.6,
            temperature_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            temperature_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            humidity_min: 38.0, humidity_max: 38.0,
            humidity_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            humidity_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            light_min: 80, light_max: 80,
            light_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            light_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pressure_min: 1011.5, pressure_max: 1011.5,
            pressure_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pressure_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            sound_min: 28, sound_max: 28,
            sound_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            sound_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            co2_min: 428, co2_max: 428,
            co2_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            co2_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            tvoc_min: 45, tvoc_max: 45,
            tvoc_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            tvoc_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pm1_min: 2, pm1_max: 2,
            pm25_min: 3, pm25_max: 3,
            pm10_min: 5, pm10_max: 5,
            pm1_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pm1_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pm25_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pm25_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pm10_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            pm10_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            aqi_min: 16, aqi_max: 16,
            aqi_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            aqi_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            health_min: 4.5, health_max: 4.5,
            health_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            health_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            noise_min: 28, noise_max: 28,
            noise_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            noise_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            motion_min: 2, motion_max: 2,
            movement_min: 1, movement_max: 1,
            motion_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            motion_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            movement_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            movement_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            co_min: 0.3, co_max: 0.3,
            no2_min: 8, no2_max: 8,
            nh3_min: 0.0, nh3_max: 0.0,
            co_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            co_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            no2_min_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            no2_max_sensor: { sensor_id: 6, sensor__name: 'HALO-SB-02' },
            nh3_min_sensor: null,
            nh3_max_sensor: null,
        },
    },

    // Tower Ground Floor (id: 300) — sensor 10 (online)
    300: {
        aggregated_data: {
            temperature_min: 21.2, temperature_max: 21.2,
            temperature_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            temperature_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            humidity_min: 44.0, humidity_max: 44.0,
            humidity_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            humidity_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            light_min: 520, light_max: 520,
            light_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            light_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pressure_min: 1012.0, pressure_max: 1012.0,
            pressure_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pressure_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            sound_min: 48, sound_max: 48,
            sound_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            sound_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            co2_min: 720, co2_max: 720,
            co2_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            co2_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            tvoc_min: 88, tvoc_max: 88,
            tvoc_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            tvoc_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pm1_min: 3, pm1_max: 3,
            pm25_min: 5, pm25_max: 5,
            pm10_min: 9, pm10_max: 9,
            pm1_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pm1_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pm25_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pm25_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pm10_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            pm10_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            aqi_min: 28, aqi_max: 28,
            aqi_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            aqi_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            health_min: 4.0, health_max: 4.0,
            health_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            health_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            noise_min: 48, noise_max: 48,
            noise_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            noise_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            motion_min: 8, motion_max: 8,
            movement_min: 4, movement_max: 4,
            motion_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            motion_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            movement_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            movement_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            co_min: 0.6, co_max: 0.6,
            no2_min: 14, no2_max: 14,
            nh3_min: 0.0, nh3_max: 0.0,
            co_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            co_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            no2_min_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            no2_max_sensor: { sensor_id: 10, sensor__name: 'HALO-TWR-GF-01' },
            nh3_min_sensor: null,
            nh3_max_sensor: null,
        },
    },

    // Tower Floor 5 (id: 304) — sensor 11 (alert: gunshot/aggression)
    304: {
        aggregated_data: {
            temperature_min: 22.8, temperature_max: 22.8,
            temperature_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            temperature_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            humidity_min: 41.5, humidity_max: 41.5,
            humidity_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            humidity_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            light_min: 310, light_max: 310,
            light_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            light_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pressure_min: 1011.5, pressure_max: 1011.5,
            pressure_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pressure_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            sound_min: 110, sound_max: 110,
            sound_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            sound_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            co2_min: 680, co2_max: 680,
            co2_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            co2_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            tvoc_min: 112, tvoc_max: 112,
            tvoc_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            tvoc_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pm1_min: 4, pm1_max: 4,
            pm25_min: 6, pm25_max: 6,
            pm10_min: 11, pm10_max: 11,
            pm1_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pm1_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pm25_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pm25_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pm10_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            pm10_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            aqi_min: 42, aqi_max: 42,
            aqi_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            aqi_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            health_min: 2.2, health_max: 2.2,
            health_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            health_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            noise_min: 110, noise_max: 110,
            noise_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            noise_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            motion_min: 95, motion_max: 95,
            movement_min: 90, movement_max: 90,
            motion_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            motion_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            movement_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            movement_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            co_min: 0.9, co_max: 0.9,
            no2_min: 16, no2_max: 16,
            nh3_min: 0.0, nh3_max: 0.0,
            co_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            co_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            no2_min_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            no2_max_sensor: { sensor_id: 11, sensor__name: 'HALO-TWR-F5-01' },
            nh3_min_sensor: null,
            nh3_max_sensor: null,
        },
    },
