...
import styles from '../../../styles/pages/Sensors/views/Sensorcardview.module.scss';
import { SensorConfig, SensorLog } from '../../../types/sensor';
import { getMetricStatusFromConfig, hasActiveConfig, getConfigForMetric } from '../../../helpers/thresholdUtils';
...
const SensorCardView: React.FC<SensorCardViewProps> = ({ sensor, latestLog, darkModeStatus, configurations }) => {
    ...
    const getValue = (key: string): any => {
        if (latestLog) {
            ...
            if (key === 'temp_c' || key === 'temperature_c') return latestLog.readings_environmental.temperature_c;
            if (key === 'humidity' || key === 'humidity_percent') return latestLog.readings_environmental.humidity_percent;
            if (key === 'light' || key === 'light_lux') return latestLog.readings_environmental.light_lux;
            if (key === 'pressure_hpa') return latestLog.readings_environmental.pressure_hpa;
    ...
    const updateTime = latestLog?.recorded_at || sensor.sensor_data?.time || sensor.timestamp;
    ...
    const getCardHighlightClass = (cardType: string): string => {
        ...
        switch (cardType.toLowerCase()) {
            case 'environment':
                ...
                statuses.push(getMetricStatus('pressure_hpa', getValue('pressure_hpa')));
                statuses.push(getMetricStatus('light', getValue('light')));
                break;
            case 'airquality':
    ...
    const aqiStatus = getAQIStatus(getValue('aqi'));
    const healthStatus = getHealthIndexStatus(getValue('health_index'));
            ...
            <div className={styles.sensorGrid}>
                ...
                <div className={`${styles.neuCard} ${styles.glossyCard} ${getCardHighlightClass('environment')}`}>
                    ...
                    <div className={styles.metricsGrid + ' ' + styles.threeCol}>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('temp_c', getValue('temp_c') || 0))}`}>
                                {getValue('temp_c') || '--'}
                                <span className={styles.unit}>°C</span>
                                {getValue('temp_f') && (
                                    <span className={styles.unit} style={{ fontSize: '0.7rem', opacity: 0.6, marginLeft: '4px' }}>
                                        / {getValue('temp_f').toFixed(1)}°F
                                    </span>
                                )}
                            </div>
                        </div>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('humidity', getValue('humidity') || 0))}`}>
                                {getValue('humidity') || '--'}
                        ...
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('pressure_hpa', getValue('pressure_hpa') || 0))}`}>
                                {getValue('pressure_hpa') || '--'}
                                <span className={styles.unit}>hPa</span>
                            </div>
                        </div>
                        <div className={styles.metricItem}>
                            <div className={styles.metricLabel}>Light</div>
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('light', getValue('light') || 0))}`}>
                                {getValue('light') || '--'}
                ...
                <div className={`${styles.neuCard} ${styles.glossyCard} ${getCardHighlightClass('particulates')}`}>
                    ...
                    <div className={styles.metricsGrid + ' ' + styles.threeCol}>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('pm1', getValue('pm1') || 0))}`}>
                                {getValue('pm1') || '--'}
                        ...
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('pm25', getValue('pm25') || 0))}`}>
                                {getValue('pm25') || '--'}
                                <span className={styles.unit}>µg/m³</span>
                            </div>
                        </div>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('pm10', getValue('pm10') || 0))}`}>
                                {getValue('pm10') || '--'}
                                <span className={styles.unit}>µg/m³</span>
                            </div>
                        </div>
                ...
                <div className={`${styles.neuCard} ${styles.glossyCard} ${getCardHighlightClass('gases')}`}>
                    ...
                    <div className={styles.metricsGrid + ' ' + styles.threeCol}>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('co', getValue('co') || 0))}`}>
                                {getValue('co') || '--'}
                        ...
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('nh3', getValue('nh3') || 0))}`}>
                                {getValue('nh3') || '--'}
                                <span className={styles.unit}>ppm</span>
                            </div>
                        </div>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('no2', getValue('no2') || 0))}`}>
                                {getValue('no2') || '--'}
                        ...
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('co2', getValue('co2') || 0))}`}>
                                {getValue('co2') || '--'}
                                <span className={styles.unit}>ppm</span>
                            </div>
                        </div>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('tvoc', getValue('tvoc') || 0))}`}>
                                {getValue('tvoc') || '--'}
                                <span className={styles.unit}>ppb</span>
                            </div>
                        </div>
                ...
                <div className={`${styles.neuCard} ${styles.glossyCard} ${getCardHighlightClass('airquality')}`}>
                    ...
                    <div className={styles.factorsList}>
                        <div className={styles.factorItem}>
                            ...
                            <div className={`${styles.factorValue} ${styles.unhealthy}`}>{getValue('pm25aqi') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>PM10</div>
                            <div className={`${styles.factorValue} ${styles.moderate}`}>{getValue('pm10aqi') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>CO2</div>
                            <div className={`${styles.factorValue} ${styles.good}`}>{getValue('co2aqi') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>NO₂</div>
                            <div className={`${styles.factorValue} ${styles.good}`}>{getValue('no2aqi') || '--'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div className={`${styles.neuCard} ${styles.glossyCard} ${getCardHighlightClass('health')}`}>
                    ...
                    <div className={styles.factorsList}>
                        <div className={styles.factorItem}>
                            ...
                            <div className={`${styles.factorValue} ${styles.unhealthy}`}>{getValue('hi_pm1') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>PM2.5</div>
                            <div className={`${styles.factorValue} ${styles.moderate}`}>{getValue('hi_pm25') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>PM10</div>
                            <div className={`${styles.factorValue} ${styles.good}`}>{getValue('hi_pm10') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>CO2cal</div>
                            <div className={`${styles.factorValue} ${styles.unhealthy}`}>{getValue('hi_co2') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>TVOC</div>
                            <div className={`${styles.factorValue} ${styles.good}`}>{getValue('hi_tvoc') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>Humidity</div>
                            <div className={`${styles.factorValue} ${styles.good}`}>{getValue('humidity') || '--'}</div>
                        </div>
                        <div className={styles.factorItem}>
                            <div className={styles.factorLabel}>NO₂</div>
                            <div className={`${styles.factorValue} ${styles.good}`}>{getValue('hi_no2') || '--'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div className={`${styles.neuCard} ${styles.glossyCard} ${getCardHighlightClass('occupancy')}`}>
                    ...
                    <div className={styles.metricItem}>
                        ...
                        <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('motion', getValue('motion') || 0))}`}>
                            {getValue('motion') || '--'}
                        </div>
                    </div>
                </div>
                ...
                <div className={`${styles.neuCard} ${styles.glossyCard} ${getCardHighlightClass('sound')}`}>
                    ...
                    <div className={styles.metricsGrid + ' ' + styles.threeCol}>
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('noise', getValue('noise') || 0))}`}>
                                {getValue('noise') || '--'}
                        ...
                        <div className={styles.metricItem}>
                            ...
                            <div className={`${styles.metricValue} ${getValue('gunshot') === 0 ? styles.success : styles.danger}`}>
                                {getValue('gunshot') === 0 ? 'Safe' : 'Alert'}
                            </div>
                        </div>
                        <div className={styles.metricItem}>
                            <div className={styles.metricLabel}>Aggression</div>
                            <div className={`${styles.metricValue} ${getStatusColorClass(getMetricStatus('aggression', getValue('aggression') || 0))}`}>
                                {getValue('aggression') || '--'}
                            </div>
                        </div>
                    </div>
